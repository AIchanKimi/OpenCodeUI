...
const GatewayPanel = lazy(() => import('./GatewayPanel').then(module => ({ default: module.GatewayPanel })))
    ...
    (activeTab: PanelTab | null) => {
      ...
      return (
        <>
          ...
          {activeTab.type === 'gateway' ? (
            <Suspense fallback={<PanelFallback />}>
              <GatewayPanel isResizing={isPanelResizing} />
            </Suspense>
          ) : null}
        </>
      )
